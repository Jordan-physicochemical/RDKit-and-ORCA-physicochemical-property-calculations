...
SMILES codes were sourced from PubChem. Linux software OpenBabel (version 3.1.1) was used to create coordinate .xyz files from each SMILES code, and these coordinates were used to create ORCA .inp input files, with charge=1 and multiplicity=0. Two different ORCA calculation methods were used, depending on compound complexity.
